...
namespace Abp.Auditing
{
    internal static class AuditingInterceptorRegistrar
    {
        ...
        private static bool ShouldIntercept(Type type)
        {
            ...
            if (type.IsDefined(typeof(AuditedAttribute), true)) //At lave: true or false?
            {
                return true;
            }

            if (type.GetMethods().Any(m => m.IsDefined(typeof(AuditedAttribute), true))) //At lave: true or false?
            {
                return true;
            }
